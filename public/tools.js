const toolsData = [
  { id: "color", icon: "🎨", title: "Color Converter", desc: "Convert between HEX and RGB", secret: "__k1:a9Vd2Kx7pQ4mZ8tL5sN1cR6hJ3fW0yG" },
  { id: "text", icon: "📊", title: "Text Analyzer", desc: "Count chars, words, lines" },
  { id: "json", icon: "{ }", title: "JSON Formatter", desc: "Format, minify, validate JSON" },
  { id: "base64", icon: "🔐", title: "Base64 Codec", desc: "Convert text to/from Base64" },
  { id: "password", icon: "🔑", title: "Password Generator", desc: "Generate secure passwords" },
  { id: "timestamp", icon: "⏰", title: "Timestamp Converter", desc: "Unix timestamp and date" },
  { id: "url", icon: "🔗", title: "URL Encoder", desc: "Encode and decode URLs" },
  { id: "hash", icon: "#️⃣", title: "Hash Generator", desc: "MD5, SHA-256, SHA-512", secret: "__k2:nB6uT9qL2hX5mV8zC4pS1kR7wD0gF3j" },
  { id: "uuid", icon: "🆔", title: "UUID Generator", desc: "Generate UUID v4" },
  { id: "base", icon: "🔢", title: "Base Converter", desc: "Binary, octal, decimal, hex" },
  { id: "regex", icon: "🔍", title: "Regex Tester", desc: "Test regex matches" },
  { id: "markdown", icon: "📝", title: "Markdown Preview", desc: "Live preview Markdown" },
  { id: "qrcode", icon: "📱", title: "QR Code Generator", desc: "Generate QR for text/URL" },
  { id: "jwt", icon: "🎫", title: "JWT Decoder", desc: "Decode JWT token contents" },
  { id: "html", icon: "🏷️", title: "HTML Entity Codec", desc: "Escape and unescape HTML" },
  { id: "case", icon: "🔤", title: "Case Converter", desc: "Upper, lower, camel, etc." },
  { id: "lorem", icon: "📄", title: "Lorem Generator", desc: "Generate placeholder text", secret: "__k3:rM8kZ1sH7jC3wY5bF0gT9xN6mQ4pL2" },
  { id: "diff", icon: "📋", title: "Text Diff", desc: "Compare two texts", secret: "__k4:pQ7hXc3Wz9F1s6Lk0bNr5D8yG2vT4mJ" },
];
